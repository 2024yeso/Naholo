          ...
          if (data['data']['top_10'] != null &&
            ...
            for (var postData in topData) {
              diaryPost_model post = diaryPost_model(
                ...
                createdAt: DateTime.parse(postData[
                    'created_at']), // 확인: POST_UPDATE에서 created_at으로 변경
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          AppBar(
            backgroundColor: Colors.white,
            toolbarHeight: SizeScaler.scaleSize(context, 50),
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  const DiaryUser(authorID: '클라이언트 ID 가져오기'),
                            ),
                          );
                        },
                        child: CircleAvatar(
                            ...
                            GestureDetector(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(
                                      width: SizeScaler.scaleSize(context, 5)),
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment:
                            ...
                            GestureDetector(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      height:
                                          SizeScaler.scaleSize(context, 4.5)),
                                  Text(
