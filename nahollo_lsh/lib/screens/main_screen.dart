      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/main_screen_bg.png'), // 배경 이미지 설정
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  padding: EdgeInsets.only(left: screenHeight * 0.01), // 좌측 여백
                  child: Column(
                    children: [
                      GestureDetector(
                ...
                Padding(
                  padding: EdgeInsets.only(right: screenHeight * 0.01), // 우측 여백
                  child: Column(
                    children: [
                      GestureDetector(
